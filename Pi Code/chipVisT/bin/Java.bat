...
set DEFAULT_JVM_OPTS="-Djava.library.path=C:\Users\Caleb\Desktop\simpleVision\Java\build/opencv"
...
@rem Execute Java
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %JAVA_OPTS%  -classpath "%CLASSPATH%" Main %CMD_LINE_ARGS%
